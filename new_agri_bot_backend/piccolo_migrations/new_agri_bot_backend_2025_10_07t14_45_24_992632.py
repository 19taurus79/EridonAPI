...
class ProductGuide(Table, tablename="product_guide", schema=None):
    id = UUID(
        default=UUID4(),
        null=False,
        primary_key=True,
...
async def forwards():
    ...
    manager.add_table(
        class_name="FreeStock", tablename="free_stock", schema=None, columns=None
    )
    ...
    manager.add_column(
        table_class_name="FreeStock",
        tablename="free_stock",
        column_name="date_in_co",
        db_column_name="date_in_co",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
